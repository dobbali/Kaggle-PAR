...
Clearly the linear Model is overfitting. This might because Linear regression with so many variable tend to overfit sometimes. Moving to XGBoosted regression model to see how it weighs the predictors and see if it can eliminate some more predictors.
...
rmse(exp(t.test$SalePrice)-1,exp(predict(xgBoostm, newdata = t.test))-1)


rmse(exp(t.train$SalePrice)-1,exp(predict(xgBoostm, newdata = t.train))-1)
