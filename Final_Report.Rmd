...
Neighborhood  LotArea       GarageCars
bathrooms     TotalBsmtSF
                                                
Functional       ExterQual        HeatingQC         PoolQC           
...
testPredictors <- c("MSSubClass","MSZoning","LotShape","LandContour",
...
for(variable in testPredictors){
...
write.csv(dt.result, 'Result_lmmm.csv')
