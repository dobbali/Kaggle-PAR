...
#1stFlrSF TotalBsmtSF 0.819529975005
#GrLivArea TotRmsAbvGrd 0.825489374309
#GarageYrBlt YearBuilt 0.825667484174
...
cat("RMSE of the model with selected variables", rmse(dt.train$SalePrice, predict(lm.sel)))  
