...
After analysing the model, it is evident that Neighbourhood is one of the significant factor in deciding sales price. Especially, ClearCr neighbourhood has great contribution to the price. a house in Edwards  costs approximately $165809 more than Blmngtn Neighborhood. 
On the other hand, No Ridge  Neighbourhood has negative effect on sales price. Presence of house in this neighbourhood with all other being same will decrease the cost by nearly $69445.
###### -- can remove
Surprisingly, GrlivArea - Liv Area above ground is one of the most significant factor to contribute to Sales price. With all other being same, one unit increase in the GrLivArea will increase sales price by $103597. 

Also when there is one unit increase in GrlivArea and house is in the StoneBr Neighborhood, there approximately the house price is increased by $32911 additionally.

#######
A well known fact which is usually considered for deciding a house price is : overallqual. A house with Quality 10 cost approximately  162181 more than a Quality 1 house.

######  -- non able to understand the interpretation here
TotalBsmtSf, GrlivArea - Total basement square feet and GarageCars - Number of cat that fit in Garage are popularly considered  important and model also reflects the same. With everything else being same, one unit in increase of Total basement area there is a price bump of $26747 and one unit increase in number of cars that can fit in car is $17357.75
...
```{r, include=F, echo=F}
lm.bt <- train(SalePrice ~ OverallQual + I(OverallQual^2) + TotalBsmtSF + GrLivArea  + GarageCars + Neighborhood + Neighborhood:GrLivArea, data= dt.train, 
            method="rf")
