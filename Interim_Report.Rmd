...
print("Above function helps to understand the combinations of variables with highest correlation which has a minimum of 0.6 as corelation value. This will identify redundant predictors ")
...
After analysing the model, it is evident that Neighbourhood is one of the significant factor in deciding sales price. Especially, StoneBr neighbourhood has great contribution to the price. a house in StoneBr costs approximately $73000 more than _______________. 
On the other hand, No Ridge  Neighbourhood has negative effect on sales price. Presence of house in this neighbourhood with all other being same will decrease the cost by nearly $29000.
...
A well known fact which is usually considered for deciding a house price is : overallqual. With one unit increase in overall quality, there is approximately $48000 increase in Sales Price. 
TotalBsmtSf - Total basement square feet and GarageCars - Number of cat that fit in Garage are popularly considered  important and model also reflects the same. With everything else being same, one unit in increase of Total basement area there is a price bump of $26747 and one unit increase in number of cars that can fit in car is $17357.75
